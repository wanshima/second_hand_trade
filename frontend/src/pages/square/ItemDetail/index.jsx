...
class ItemDetail extends Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'squareAndItemDetail/fetchItemDetail',
      payload: match.params
    });
  }

  render() {
    const { squareAndItemDetail, loading } = this.props;

    return (
      <PageHeaderWrapper
        title={squareAndItemDetail.product ? squareAndItemDetail.product.name : false }
        extra={action}
...
export default connect(({ squareAndItemDetail, loading }) => ({
  squareAndItemDetail,
  loading: loading.effects['squareAndItemDetail/fetchItemDetail'],
}))(ItemDetail);
